<aside class="bg-white w-64 min-h-screen flex flex-col shadow-lg transform -translate-x-full md:translate-x-0 transition-transform duration-150 ease-in fixed md:static z-30" id="sidebar">
    ...
    <nav class="flex-grow p-4" id="sideBar">
        ...
        <a href="/quizzes" class="block p-3 mb-2 text-gray-800 hover:bg-gray-100 rounded-lg">
            <i class="fas fa-book mr-2"></i> My Quizzes
        </a>
        <a href="/createquiz" class="block p-3 mb-2 text-gray-800 hover:bg-gray-100 rounded-lg">
            <i class="fas fa-plus mr-2"></i> Create Quiz
        </a>
        <a href="/statistics" class="block p-3 mb-2 text-gray-800 hover:bg-gray-100 rounded-lg">
            <i class="fas fa-chart-bar mr-"></i> Statistics
        </a>
